...
describe("Page rendering", () => {
  ...
  it("homepage displays correct tool count", () => {
    renderWithRoute("/", <Index />);
    expect(screen.getByText(/31 Tools/)).toBeInTheDocument();
  });

  it("homepage has all 31 tool cards", () => {
    renderWithRoute("/", <Index />);
