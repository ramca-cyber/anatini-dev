...
features:
  ...
  return (
    <ToolPage icon={ArrowRight} title="YAML → JSON Converter" description="Convert YAML documents to JSON format." pageTitle="YAML → JSON Converter — Free, Offline | Anatini.dev" metaDescription={getToolMetaDescription("yaml-to-json")} seoContent={getToolSeo("yaml-to-json")}>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground">YAML Input</label>
