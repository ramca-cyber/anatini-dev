      ...
      <div className="container flex h-14 items-center justify-between">
        ...
        <div className="hidden items-center gap-0.5 md:flex">
          <button
            ...
            className={`inline-flex items-center gap-1 ${navLinkClass(isToolPage || megaOpen)}`}
          >
        ...
        <div className="flex items-center gap-2">
          <div className="hidden items-center gap-1.5 border border-border bg-secondary px-3 py-1 text-xs text-muted-foreground sm:flex">
        ...
        <div ref={mobileMenuRef} className="border-t border-border bg-background p-4 md:hidden max-h-[80vh] overflow-y-auto">
          <div className="flex flex-col gap-0.5">
            ...
            <Link
              to="/blog"
              onClick={() => setMobileOpen(false)}
              className="px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-secondary hover:text-foreground"
            >
              Blog
            </Link>
            <Link
